            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        copy = await bot.send_document(chat_id=m.chat.id,document=ka, caption=cc1, thumb=thumbnail)
                    ...
                    try:
                        ...
                        copy = await bot.send_document(chat_id=m.chat.id,document=f'{name}.pdf', caption=cc1, thumb=thumbnail)
                        await copy.copy(chat_id = -1001296608859)
                        count += 1
