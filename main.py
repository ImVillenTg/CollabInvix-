    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "tencdn.classplusapp" in url and "videos.classplusapp" in url and "media-cdn.classplusapp.com" in url:
              r1 = requests.get('https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hM33P2ai6ivdzxPPfm01LAd4JWv-vnrSxGXqvCirCSpUfhhofpeqyeHPxtstXwe0'})
              u = r1.json()['url']
